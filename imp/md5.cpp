...
inline void MD5::FF(std::uint32_t &a, std::uint32_t b, std::uint32_t c,
                    std::uint32_t d, std::uint32_t x, std::uint32_t s, std::uint32_t ac)
{
    a = RotateLeft(a + F(b, c, d) + x + ac, s) + b;
}

inline void MD5::GG(std::uint32_t &a, std::uint32_t b, std::uint32_t c,
                    std::uint32_t d, std::uint32_t x, std::uint32_t s, std::uint32_t ac)
{
    a = RotateLeft(a + G(b, c, d) + x + ac, s) + b;
}

inline void MD5::HH(std::uint32_t &a, std::uint32_t b, std::uint32_t c,
                    std::uint32_t d, std::uint32_t x, std::uint32_t s, std::uint32_t ac)
{
    a = RotateLeft(a + H(b, c, d) + x + ac, s) + b;
}

inline void MD5::II(std::uint32_t &a, std::uint32_t b, std::uint32_t c,
                    std::uint32_t d, std::uint32_t x, std::uint32_t s, std::uint32_t ac)
{
...
void MD5::Decode(std::uint32_t output[], const std::uint8_t input[], std::uint32_t len)
{
    for (unsigned int i = 0, j = 0; j < len; i++, j += 4) {
        output[i] = ((std::uint32_t)input[j]) |
                (((std::uint32_t)input[j + 1]) << 8) |
